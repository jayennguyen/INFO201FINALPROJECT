...
univeristy.raw.only.earning <- select(univeristy.raw, university.name.state, columns.earning)
...
univeristy.raw.only.tuition <- select(univeristy.raw, university.name.state, column.tuition)
...
univeristy.raw.only.tuition <- select(univeristy.raw.only.tuition, university.name.state, realcost)
...
combine.earning.tuition <- select(combine.earning.tuition,university.name.state, "realcost", only.mean.earning)
